    ...
    <v-container>
      <v-row no-gutters>
        <v-col>
          ...
          >
            <v-list class="mt-16" shaped>
              <v-list-item>
                <v-list-item-title class="title ml-7 text-decoration-underline"
                  >目录</v-list-item-title
                >
              </v-list-item>

              <v-hover v-slot="{ hover }">
                <v-list-item
                  @click="$vuetify.goTo('#live')"
                  :class="{ 'red white--text': hover }"
                >
                  <v-list-item-title class="ml-8">实时更新</v-list-item-title>
                </v-list-item>
              </v-hover>

              <v-hover v-slot="{ hover }">
                <v-list-item
                  @click="$vuetify.goTo('#date')"
                  :class="{ 'red white--text': hover }"
                >
                  <v-list-item-title class="ml-8">重要日期</v-list-item-title>
                </v-list-item>
              </v-hover>

              <v-hover v-slot="{ hover }">
                <v-list-item
                  @click="$vuetify.goTo('#form_faq')"
                  :class="{ 'red white--text': hover }"
                >
                  <v-list-item-title class="ml-8"
                    >填写表格疑问</v-list-item-title
                  >
                </v-list-item>
              </v-hover>
              ...
              <v-hover v-slot="{ hover }">
                <v-list-item
                  @click="$vuetify.goTo('#class_faq')"
                  :class="{ 'red white--text': hover }"
                >
                  <v-list-item-title class="ml-8"
                    >日常上课疑问</v-list-item-title
                  >
                </v-list-item>
              </v-hover>
              ...
              <v-hover v-slot="{ hover }">
                <v-list-item
                  @click="$vuetify.goTo('#fee_faq')"
                  :class="{ 'red white--text': hover }"
                >
                  <v-list-item-title class="ml-8">学费疑问</v-list-item-title>
                </v-list-item>
              </v-hover>

              <v-hover v-slot="{ hover }">
                <v-list-item
                  @click="$vuetify.goTo('#course_faq')"
                  :class="{ 'red white--text': hover }"
                >
                  <v-list-item-title class="ml-8">科系问题</v-list-item-title>
                </v-list-item>
              </v-hover>

              <v-hover v-slot="{ hover }">
                <v-list-item
                  @click="$vuetify.goTo('#dresscode_faq')"
                  :class="{ 'red white--text': hover }"
                >
                  <v-list-item-title class="ml-8">衣着问题</v-list-item-title>
                </v-list-item>
              </v-hover>

              <v-hover v-slot="{ hover }">
                <v-list-item
                  @click="$vuetify.goTo('#scolarship_faq')"
                  :class="{ 'red white--text': hover }"
                >
                  <v-list-item-title class="ml-8">奖贷学金</v-list-item-title>
                </v-list-item>
              </v-hover>

              <v-hover v-slot="{ hover }">
                <v-list-item
                  @click="$vuetify.goTo('#hostel_faq')"
                  :class="{ 'red white--text': hover }"
                >
                  <v-list-item-title class="ml-8">宿舍问题</v-list-item-title>
                </v-list-item>
              </v-hover>

              <v-hover v-slot="{ hover }">
                <v-list-item
                  @click="$vuetify.goTo('#environment_faq')"
                  :class="{ 'red white--text': hover }"
                >
                  <v-list-item-title class="ml-8"
                    >校内&校外环境与生活问题</v-list-item-title
                  >
                </v-list-item>
              </v-hover>
              ...
              <v-hover v-slot="{ hover }">
                <v-list-item
                  @click="$vuetify.goTo('#degree_faq')"
                  :class="{ 'red white--text': hover }"
                >
                  <v-list-item-title class="ml-8">往后升学</v-list-item-title>
                </v-list-item>
              </v-hover>

              <v-hover v-slot="{ hover }">
                <v-list-item
                  @click="$vuetify.goTo('#upu_faq')"
                  :class="{ 'red white--text': hover }"
                >
                  <v-list-item-title class="ml-8"
                    >UPU申请问题</v-list-item-title
                  >
                </v-list-item>
              </v-hover>
            </v-list>
        ...
        <v-col cols="12" class="col-md-10 mr-md-8">
          <v-row id="live">
            <v-col>
              <p class="headline text-center">
                <v-icon
                  color="red"
                  class="animate__animated animate__fadeInLeft animate__infinite"
                >
                ...
                <v-icon
                  color="red"
                  class="animate__animated animate__fadeInRight animate__infinite"
                >
              ...
              <span class="text-center">
                <p>
                  Foundation回忆录实时更新版本
                  <a
                    href="https://docs.google.com/document/d/1JIv_cj_trtyMBduYT572OWnSf8xK8tJxdOg2oG0bQmc/edit?usp=sharing"
                    target="_blank"
                    class="red--text"
                    >点击这里</a
                  >
          ...
          <v-row id="date">
            <v-col>
              ...
              <p class="title">UTM FOUNDATION PROGRAMME</p>
              <p class="subtitle-1">INTAKE: JULY 2022</p>
              <v-simple-table>
              ...
              <v-expansion-panels>
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    1. No. Pendaftaran / Program 要填什么？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    No. Pendaftaran是Surat tawaran上面的No
                    rujukan，Program呢就是你拿到的科系，Kod Program
                    可以查询Panduan Borang P5，Foundation同学的kod是FSPA。
                  </v-expansion-panel-content>
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    2. Tinggi / Kumpulan darah 如果我不知道的话可以空着吗？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    血型不懂可以先空着。
                  </v-expansion-panel-content>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    3. Agregat / Pangkat 要填什么？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    Agregat和Pangkat不需要填哦。
                  </v-expansion-panel-content>
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    4. Penjamin可以放父母/亲戚（跟Saudara pertama &
                    kedua一样）吗？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    Penjamin
                    可以放父母也可以放符合条件的亲戚，条件为月薪需要超过RM500（但需注意Saudara
                    pertama & kedua需要填写父母以外可以第一时间联络到的人）
                  </v-expansion-panel-content>
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    5. 如果RM10的setem hasil完了，我可以用两张RM5的setem
                    hasil代替吗？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    可以，但是要注意黏上去时候2张setem hasil没有重叠到。
                  </v-expansion-panel-content>
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    6. 哪里可以matikan setem？UTC可以吗？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    UTC已经不能matikan setem
                    了，必须去LHDN。此外，Pahang的Pejabat Tanah也可以matikan
                    setem。
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    7. 如果我本人没有去而是请朋友帮我matikan setem可以吗？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    不可以哦，因为matikan
                    setem时候需要填写个人资料，建议是亲自去。
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    可以到Pejabat Pos购买或是直接在Lembaga Hasil Dalam Negeri
                    (LHDN) 买了然后matikan
                    setem。（注意：申请PTPTN时候也需要Setem
                    hasil，但是需要官员到校亲自matikan
                    setem，建议事先买了保存收好）
                    <ul>
                      <li>
                        即日起LHDN已经废除以下的样子的Setem Hasil，以Sijil
                        Setem来代替了，仍然可以使用于Borang 3a跟3b哦
                      </li>
                      <li>PTPTN的setem hasil建议在Pos Malaysia购买。</li>
                    </ul>
                    <br />
                    <v-row>
                      <v-col md="2">
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    9. 我需要准备多少张RM10的setem hasil呢？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    总共是4张（若没有申请PTPTN，只需2张） <br />
                    a. 2张贴在Borang 3a & 3b，需要自己到LHDN去matikan setem
                    <br />
                    b. 2张准备给PTPTN，不需要matikan setem否则就作废了
                  </v-expansion-panel-content>
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    10. 我的父母退休了/没有工作，请问需要填写Borang Pengesahan
                    Pendapatan吗？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    需要填写Borang Pengesahan
                    Pendapatan，薪水则填写RM0。若是退休的公务员，每个月都会有一份报告单，可以用来作为证明。而如果是家里母亲为家庭主妇的话，则不需要填这个borang。
                  </v-expansion-panel-content>
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    11. 请问我可以找谁sahkan我的borang和文件？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    最方便的是寻找（政府）学校的校长/副校长，如果他们都不在可以询问任何主任是否适合并且愿意帮忙。（若学校行政因Covid-19受影响而关闭的话，建议寻找您区域的州/国议员，帮你sah）
                    <br />
                    <ol type="a" start="3">
                      <li>
                        sah文件副本可以找Pengetua/ Guru Besar, Pegawai Kerajaan
                        Kumpulan 1, Wakil Rakyat, Jaksa Pendamai (JP), Ketua
                        Jajahan, Ketua Bahagian atau Ketua Kampung.
                      </li>
                      <li>
                        签Penjamin的Borang可以找Wakil Rakyat, Jaksa Pendamai,
                        Pegawai Kerajaan Bahagian 1, Pengetua/Guru Besar, Ketua
                        Jajahan, Ketua Bahagian dan Ketua Kampung.
                      </li>
                      <li>
                        而Borang Pengesahan Pendapatan有注明需要Pengetua, Guru
                        Besar Sekolah (Sekolah Kerajaan sahaja), Penghulu,
                        Penggawa, Tuai Rumah, Ketua Kaum atau Mukim Bertauliah,
                        Pegawai Kerajaan Kumpulan Pengurusan dan Profesional
                        (dahulunya Kumpulan A), Pengamal Undang-Undang,
                        Pesuruhjaya Sumpah, Jaksa Pendamai atau Ahli Majlis
                        Mesyuarat Negeri (Ahli EXCO).
                      </li>
                    </ol>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    12. Borang P5 里面的第26项 Alamat Semasa Pengajian要填吗？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    不需要哦，除非大学期间不住在校内宿舍。
                  </v-expansion-panel-content>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    13.
                    我印出来了才发现我有填错东西，我需要重新印过还是可以用correction
                    tape修改吗？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    如果发现表格有需要修改的地方，建议使用红笔做出更改就好。
                  </v-expansion-panel-content>
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    14. 请问我需要用70gsm还是80gsm的纸复印我的文件呢？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    没有特别要求需要用哪一种纸哦，但是建议使用80gsm的纸打印重要文件，以防呈交时文件受损。
                  </v-expansion-panel-content>
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    15. 有什么borang是需要印两份出来的吗？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    建议根据校方给的Set Tawaran Kemasukan来打印和复印。
                    <v-img
                      src="../assets/foundation_brg.jpg"
                      max-width="728"
                    ></v-img>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    <ol type="a">
                      <li>Salinan Surat Tawaran (2 Salinan)</li>
                      <li>Salinan Sijil SPM atau setaraf (2 Salinan)</li>
                      <li>Salinan Kad Pengenalan (2 Salinan)</li>
                      <li>
                        Salinan Surat Beranak Pemohon, Ibu bapa, Penjaga (2
                        Salinan)
                      </li>
                      <li>Salinan Sijil Berhenti Sekolah (2 Salinan)</li>
                    </ol>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    17. Borang 要用portrait还是landscape来打印？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    使用portrait来打印哦。
                  </v-expansion-panel-content>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    是没有注明需要最新的薪水单，但是建议使用最新的哦。
                  </v-expansion-panel-content>
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    19. 照片需要多少张呢?什么size的？背景要蓝底还是白底？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    一份Borang
                    P5需要一张。为了避免日后申请其他事项需要用到，可以准备多几张预备着。根据Borang
                    P5的要求是ic size的，<span class="font-weight-bold"
                      >只可以使用白底</span
                    >。
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    20. Penjamin需要薪水单吗？<span class="font-weight-bold"
                      >（注意:
                      Penjamin需要至少500或以上个的收入才能当penjamin）</span
                    >
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    Penjamin不需要薪水单哦，他们是作为你在utm读书期间的担保人，需要担保你在读书期间有办法偿还学费以及其他费用。校方若在处理费用方面出了问题将会联系这两位担保人。
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    21. 请问下Borang 3a & 3b
                    如果penjamin的房子贷款还没付完，就不算自己的所以不需要写进去是吗？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    其实是可以写进去的，因为很多人的房子都是在贷款。虽然说是在贷款，但是名义上房子已经属于自己的了，只是和银行借钱。
                  </v-expansion-panel-content>
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    22. 如果工作没有kwsp的话，gaji bersih和jumlah
                    pendapatan可以写一样的吗？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    可以。
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    建议到外面的照相馆拍，记得要穿formal或者有领的整齐衣服。
                  </v-expansion-panel-content>
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    24. Nama majikan 是写公司名字还是老板的名字？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <ol type="a">
                      <li>Alamat Pejabat 写工作的地址</li>
                      <li>Nama Majikan 写雇主/公司的名字</li>
                      <li>Alamat Majikan 写公司注册的地址</li>
                    </ol>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    25. Borang
                    P5里面需要我填写银行名字以及户口号码，请问一下UTM的Panel
                    Bank是什么银行？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <v-simple-table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>UTM Kuala Lumpur</td>
                          <td>Bank Islam malaysia Berhad</td>
                        </tr>
                      </tbody>
                    </v-simple-table>
                    <span class="font-weight-bold"
                      >只可以开设学校官方指定户口！！！Degree时期学校只限制Panel
                      Bank的交易。</span
                    >
                    <br />
                    <span class="font-weight-bold red--text"
                      >PTPTN的银行户口是强制性的！！！必须在指定银行开户，不可以使用其他银行的户口来申请PTPTN！！！<span
                        class="red white--text"
                        >（PTPTN的指定银行为Bank Islam）</span
                      ></span
                    >
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    26.
                    我现在没有任何个人名字银行户口，可是我有与父母的联名户口，请问可以用吗？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    如果是联名户口，建议把他分出来成个人户口或者开设一个新的个人户口，因为当UTM需要退款的时候，必须核实到时学生的名字方可继续处理，<span
                      class="font-weight-bold"
                      >若没有将会有所耽搁或者照成退款失败。<span
                        class="red white--text"
                        >（如果你还没有过生日，一样可以开户！只是银行账户会限定交易额度，这个额度可以在生日后到银行更新。）</span
                      ></span
                    >
                  </v-expansion-panel-content>
                </v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <v-simple-table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>Offer Letter/Surat Kebenaran</td>
                          <td>Offer Letter/Surat Kebenaran</td>
                        </tr>
                        <tr>
                          <td>-</td>
                          <td>报生纸（Sijil Kelahiran/Birth Certificate）</td>
                        </tr>
                        <tr>
                          <td>-</td>
                          <td>任何一位父母（需要帮忙签名）</td>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    28. 有没有任何的Borang kemasukan的sample？
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    有，可以参考这个链接：<a
                      href="https://drive.google.com/drive/folders/18vRsYVu0sjYLAtdbQeIuMl0Qo_Rqg7wh?usp=sharing"
                      target="_blank"
                      class="red--text"
                      >BORANG KEMASUKAN KE UTM - SAMPLE</a
                    >
                    <br />
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    30. Borang 3a跟3b的问与答还有小科普！
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <span class="font-weight-bold">Borang 3a and 3b Q&A</span>
                    <ol type="1">
                      <li>
                        <span class="font-weight-bold"
                          >请问表格里面的两个penjamin都可以放父母是吗？</span
                        ><br />
                        可以，只要双方都有做工，并且薪资有RM500以上即可。
                      </li>
                      <li>
                        <span class="font-weight-bold"
                          >请问一下两个penjamin都一定要放父母嘛？</span
                        ><br />
                        不一定，你的亲戚朋友，或者已经就业的哥哥或者姐姐也可以。
                      </li>
                      <li>
                        <span class="font-weight-bold"
                          >请问一下Penjamin可以写外人嘛？</span
                        ><br />
                        是可以，但是不建议。详细情况建议参考下面的Borang 3a3b
                        小科普。
                      </li>
                      <li>
                        <span class="font-weight-bold"
                          >请问一下Penjamin可以写在新加坡就业的人吗？</span
                        ><br />
                        不确定，但是最好填写本地就业的，因为方便联系。
                      </li>
                      <li>
                        <span class="font-weight-bold"
                          >请问两个penjamin可以同一个人嘛？</span
                        ><br />
                        不可以，必须都是不同的两个人。
                      </li>
                      <li>
                        <span class="font-weight-bold"
                          >为什么需要去到LHDN matikan setem呢？</span
                        ><br />
                        由于Borang
                        3a跟3b牵扯到担保人的部分，所以必须要有政府部门的签署，这样这两份文件才具有法律效益哦。
                      </li>
                    </ol>
                    <span class="font-weight-bold">Borang 3a3b小科普</span
                    ><br />
                    Borang 3a and
          ...
          <v-row class="mt-16" id="class_faq">
            <v-col>
              <p class="headline text-center">
                <v-icon
                  color="red"
          ...
          <v-row class="mt-16" id="course_faq">
            <v-col>
              <p class="headline text-center">
                <v-icon
                  color="red"
              ...
              <v-expansion-panels>
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <a
                      href="https://drive.google.com/file/d/1Nut5rfA3nusHGolAjWBZBNYDLDVIfx9e/view?usp=sharing"
                      target="_blank"
                      class="red--text"
                      >【清楚的版本，按这边】</a
                    >
                    <v-img
                      src="../assets/foundation_timetable.jpg"
                      width="1600"
                    ></v-img>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <a
                          ...
                          target="_blank"
                          >Buku Panduan Kewangan Program Asasi UTM</a
                        >）
                      </li>
                    </ul>
                  </v-expansion-panel-content>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <span class="font-weight-bold"
                      >*不包括practical课，Practical课一律3 Hours per Week per
                      Subject。</span
                    >
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    可以
                    <a
                      href="https://docs.google.com/spreadsheets/d/1CBsJfPlzrpWDCm4NE6IwG4RPQJR_M27b/edit#gid=947870231"
                      target="_blank"
                      class="red--text"
                      >点击这里</a
                    >
          ...
          <v-row class="mt-16" id="dresscode_faq">
            <v-col>
              <p class="headline text-center">
                <v-icon
                  color="red"
              ...
              <v-expansion-panels>
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    可以参考以下图片：<br />
                    <v-img src="../assets/dress1.png" max-width="842"></v-img>
                    <v-img src="../assets/dress2.jpg" max-width="800"></v-img>
                  </v-expansion-panel-content>
                </v-expansion-panel>
          ...
          <v-row class="mt-16" id="scolarship_faq">
            <v-col>
              <p class="headline text-center">
                <v-icon
                  color="red"
              ...
              <v-expansion-panels>
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <a
                      href="https://www.biasiswamalaysia.com/"
                      target="_blank"
                      class="red--text"
                      >Biasiswa Malaysia</a
                    >
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <a
                      href="https://www.ptptn.gov.my/permohonan-pinjaman-side"
                      class="red--text"
                      target="_blank"
                      >https://www.ptptn.gov.my/permohonan-pinjaman-side</a
                    >
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <br />
                    开户链接：<a
                      href="https://www.ptptn.gov.my/esmas-open-acc-web/#/openAccount"
                      class="red--text"
                      target="_blank"
                      >https://www.ptptn.gov.my/esmas-open-acc-web/#/openAccount</a
                    >
                  </v-expansion-panel-content>
                </v-expansion-panel>
              </v-expansion-panels>
          ...
          <v-row class="mt-16" id="hostel_faq">
            <v-col>
              <p class="headline text-center">
                <v-icon
                  color="red"
              ...
              <v-expansion-panels>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <a
                      href="https://www.facebook.com/pmbutmkl"
                      target="_blank"
                      class="red--text"
                      >马来西亚工艺大学吉隆坡分校佛学会（华文学会）</a
                    >
                    提供照片）：
                    <v-img
                      src="../assets/ksj_room.jpg"
                      max-width="1080"
                    ></v-img>
                    <v-img
                      src="../assets/ksj_toilet.jpg"
                      max-width="1080"
                    ></v-img>
                    <v-img
                      src="../assets/ksj_pantry.jpg"
                      max-width="1080"
                    ></v-img>
                    <v-img
                      src="../assets/ksj_washing.jpg"
                      max-width="1080"
                    ></v-img>
                    <v-img
                      src="../assets/ksj_laundry.jpg"
                      max-width="1080"
                    ></v-img>
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <v-row>
                      ...
                      <v-col>
                        <v-img
                          src="../assets/kp_male4.jpg"
                          max-width="750"
                        ></v-img>
                      </v-col>
                      <v-col>
                        <v-img
                          src="../assets/kp_male5.jpg"
                          max-width="560"
                        ></v-img>
                      </v-col>
                      <v-col>
                        <v-img
                          src="../assets/kp_male6.jpg"
                          max-width="560"
                        ></v-img>
                      </v-col>
                      <v-col>
                        <v-img
                          src="../assets/kp_male7.jpg"
                          max-width="750"
                        ></v-img>
                      </v-col>
                    </v-row>
                    ...
                    <v-row>
                      ...
                      <v-col>
                        <v-img src="../assets/k10b.jpg" max-width="684"></v-img>
                      </v-col>
                      <v-col>
                        <v-img src="../assets/k10c.jpg" max-width="684"></v-img>
                      </v-col>
                      <v-col>
                        <v-img src="../assets/k10d.jpg" max-width="684"></v-img>
                      </v-col>
                      <v-col>
                        <v-img src="../assets/k10e.jpg" max-width="684"></v-img>
                      </v-col>
                      <v-col>
                        <v-img
                          src="../assets/k10f.jpg"
                    ...
                    <v-row>
                      <v-col md="6">
                        <v-img src="../assets/k9a.jpg" max-width="1440"></v-img>
                      </v-col>
                      <v-col md="6">
                        <v-img src="../assets/k9b.jpg" max-width="1440"></v-img>
                      </v-col>
                      <v-col md="6">
                        <v-img src="../assets/k9d.jpg" max-width="1440"></v-img>
                      </v-col>
                      <v-col md="6">
                        <v-img src="../assets/k9e.jpg" max-width="1440"></v-img>
                      </v-col>
                      <v-col md="6">
                        <v-img src="../assets/k9f.jpg" max-width="1200"></v-img>
                      </v-col>
                      <v-col md="6">
                        <v-img src="../assets/k9g.jpg" max-width="1200"></v-img>
                      </v-col>
                      <v-col md="6">
                        <v-img src="../assets/k9c.jpg" max-width="1200"></v-img>
                      </v-col>
                      <v-col md="6">
                        <v-img src="../assets/k9h.jpg" max-width="1200"></v-img>
                      </v-col>
                      <v-col>
                        <v-img
                          src="../assets/k9i.jpg"
          ...
          <v-row class="mt-16" id="environment_faq">
            <v-col>
              <p class="headline text-center">
                <v-icon
                  color="red"
              ...
              <v-expansion-panels>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <v-row>
                      <v-col>
                        <iframe
                          ...
                          width="560"
                          height="315"
                          src="https://www.youtube-nocookie.com/embed/JT7LedfgX1Q"
                    ...
                    <v-row>
                      <v-col>
                        ...
                        <a
                          class="red--text"
                          href="https://www.facebook.com/pmbutmkl/posts/480081150410035"
                          target="_blank"
                          >Part 1</a
                        >，<a
                          class="red--text"
                          href="https://www.facebook.com/pmbutmkl/posts/480698553681628"
                          target="_blank"
                          >Part 2</a
                        >，<a
                          class="red--text"
                          href="https://www.facebook.com/pmbutmkl/posts/481342093617274"
                          target="_blank"
                          >Part 3</a
                        >
                      </v-col>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    2. 学校附近有market吗？</v-expansion-panel-header
                  >
                  <v-expansion-panel-content
                    >UTM KL校内有
                    <a
                      href="https://goo.gl/maps/8NLWtfKBQbuPji388"
                      class="red--text"
                      target="_blank"
                      >Gurney mall</a
                    >，mall里面同时也有公寓（最便宜的配套是RM1100，2张单人床，冷气，清理服务，wifi，泳池；详细的可以到
                    <a
                      href="https://www.instagram.com/residensiutmkl.official/"
                      class="red--text"
                      target="_blank"
                      >Residensi UTM KL</a
                    >
                    ...
                    <iframe
                      ...
                      width="560"
                      height="315"
                      src="https://www.youtube-nocookie.com/embed/Ck9nc0fAY58"
                      title="YouTube video player"
                      frameborder="0"
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                      allowfullscreen
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    3. 通常生活费是多少？</v-expansion-panel-header
                  >
                  <v-expansion-panel-content>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    4.
                    那么你们是去哪里洗衣服的？洗了晒在哪里？</v-expansion-panel-header
                  >
                  <v-expansion-panel-content>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    U。或者是用Food
                    Panda选择叫Delivery，和校外的华人餐厅外卖。</v-expansion-panel-content
                  >
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    6. 宿舍里面有饮水机吗？</v-expansion-panel-header
                  >
                  <v-expansion-panel-content>
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    7.
                    宿舍的房间有电风扇是吗？然后tilam不用带对吗？</v-expansion-panel-header
                  >
                  <v-expansion-panel-content
                    >宿舍提供的风扇是安装在天花板的吊扇哦。而tilam则是不需要带的因为宿舍是有提供床褥的，如果同学觉得有需要的话也是可以带的。
                  </v-expansion-panel-content>
                </v-expansion-panel>

                <v-expansion-panel>
                  <v-expansion-panel-header>
                    8. UTM JB的公交设施如何？</v-expansion-panel-header
                  >
                  <v-expansion-panel-content
                    >B 呢有Bus Muafakat
                    ...
                    <br />
                    <a
                      href="https://drive.google.com/drive/folders/1P6zVO0e_CXz0S9OBWoQ8smv0eKRv7KDr?usp=sharing"
                      target="_blank"
                      class="red--text"
                      >点击我查看路线</a
                    >
                ...
                <v-expansion-panel>
                  <v-expansion-panel-header
                    >9.
                    如果我家住靠近学校或者我是住外面的话，需要怎样搭公共交通到学校呢？</v-expansion-panel-header
                  >
                  <v-expansion-panel-content>
                    UTM KL路线： <br /><br />
                    路线一 <br />
                    搭LRT去到
                    <span class="red white--text">Dato Keramat</span>
                    然后在那里等个
                    <span class="red white--text">220号</span>
                    的巴士并搭上，220号巴士有一站会<span class="red white--text"
                      >停在UTM KL大门对面的巴士站</span
                    >。 <br /><br />
                    路线二 <br />
                    若不太想等巴士，也可以搭 LRT 去到
                    <span class="red white--text">Damai</span>
          ...
          <v-row class="mt-16" id="degree_faq">
            <v-col>
              <p class="headline text-center">
                <v-icon
                  color="red"
              ...
              <v-expansion-panels>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <a
                      class="red--text"
                      href="https://drive.google.com/file/d/1Njh6Q0Pp7H1yXTXiO_ouPE1lzZ-9tWLP/view?usp=sharing"
                      target="_blank"
                      >UTM Degree Application List 2022 - UTM Foundation.pdf</a
                    >
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <span class="red--text font-weight-bold"
                      >注意：每年的可以通过UTM Foundation来申请UTM
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <br />
                    各个科目的录取门槛可以参考这边：<a
                      href="https://admission.utm.my/entry-requirements-ug-malaysian/"
                      target="_blank"
                      class="red--text"
                      >Syarat Kemasukan ke UTM Degree</a
                    >
                  </v-expansion-panel-content>
                </v-expansion-panel>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    Mainstream课程。 <br />
                    <span class="font-weight-bold"
                      >建议学生们自己报考MUET，因为自己报考MUET可以比较便宜而且可以自己选择考场，不需要支付昂贵的考试费。（只是不会给予补习班，需要自习）</span
                    >
                    <br />
                    <span class="font-weight-bold"
                      >Normal Fee: MUET : RM101 / MOD: RM250</span
                    >
                    <br />
                    <span class="font-weight-bold"
                      >MUET :Register online and make payment during
                      registration.</span
                    >
                    <br />
                    <span class="font-weight-bold"
                      >MoD: Register online and make payment after
                      registration.</span
                    >
            ...
            <v-col>
              ...
              <v-expansion-panels>
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    1. 若我想要使用UTM
                    Foundation成绩来申请UPU的话，我需要在Kategori跟Lepasan填写什么？<span
                      class="font-weight-bold"
                      >（不需要买pin了，直接在UPU官方申请即可）</span
                    >
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                ...
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    Diploma/Setaraf填写如下：
                    <v-img
                      src="../assets/foundation_enddate.jpg"
                      max-width="751"
                    ></v-img>
                    <span class="font-weight-bold"
                      >Tarikh Tamat
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a
                              class="red--text"
                              href="https://apps.foundation.utmspace.edu.my/student/login?returnUrl=/student/"
                              target="_blank"
                              >SMP</a
                            >（Sistem Maklumat Pelajar），print出来或者save as
                            PDF
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a
                              class="red--text"
                              href="https://www2.mqa.gov.my/mqr/english/epapar_printAA.cfm?IdAkrKP=17343"
                              target="_blank"
                              >下载</a
                            >
                            来download.
